...
class DocentesView(ft.Container):
    ...
    def mostrar_formulario_editar(self, docente_id):
        print(f"🧩 Abriendo ventana de edición para persona {docente_id}")
        from acciones.editar_docente_view import EditarDocenteView

        # Crear la vista de edición sin usar volver_atras
        editar_vista = EditarDocenteView(self.page, None, docente_id)
    ...
    def mostrar_formulario_editar(self, docente_id):
        print(f"🧩 Navegando a vista de edición para persona {docente_id}")
        from acciones.editar_docente_view import EditarDocenteView
