import flet as ft
from pelicula.pelicula_view import PeliculasView  # ← importar aquí   
...
class DashboardView(ft.Container):
    ...
    def mostrar_tabla(self, nombre_tabla):
        if nombre_tabla == "Personas":
                    personas_vista = PeliculasView(self.page, volver_atras=lambda: self.cambiar_vista(DashboardView(self.page, self.cambiar_vista)))
